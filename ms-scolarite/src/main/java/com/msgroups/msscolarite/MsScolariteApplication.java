...
import com.msgroups.msscolarite.Repositories.*;
import com.msgroups.msscolarite.Entities.*;
...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) { SpringApplication.run(MsScolariteApplication.class, args); }
